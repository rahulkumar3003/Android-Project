...
<title>Mankind pharmaatics</title>
...
<body>
	...
	<div class="container">
    	...
    	<nav class="menubar1">
    		<ul>
    			<li><a href="mankind.html">Home</a></li>
  ...
  <h4><p class="ex"><marquee>If you have any queries or complaints, you can contact us by writing to us. We request you to be as specific as possible so that we can respond to you with accurate answers, in an expedient manner.</marquee></p></h4>
  <div id="maindiv">
  	<div id="subdiv1">
    	<!--div id="form">
        	<h3>Name&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input type="text" name="name" /></h3><br /><br />
        	<h3>Phone No.&nbsp&nbsp&nbsp&nbsp<input type="text" name="phone" /></h3><br />
            <h3>Email<input type="text" name="email" /></h3><br />
            <h3>Address<input type="text" name="address" /></h3><br /><br />
            <h3>Massage<input type="text" name="massage" /></h3><br /><br />
    	...
    	<table width="500" height="400" border="2" align="center" bgcolor="#FFCCFF">
            ...
            <tr>
				...
				<td><textarea name="address" cols="18px"></textarea><!--input type="text" name="address" /-->
            ...
            <tr>
				...
				<td><textarea name="massage" cols="18px"></textarea><!--input type="text" name="massage" /-->
...
<div id="copyright">
  <table border="2px" bgcolor="#00FF99" width="1000px" height="50">
    <tr>
    	<td>
		<p style="font-size:15px">&nbsp;&nbsp;&nbsp;&copy;Mankind pharma 2016 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Design by:&nbsp;&nbsp;&nbsp;&nbsp;RAHUL KUMAR</p>
        </td>
    </tr>
  </table>
</div>
